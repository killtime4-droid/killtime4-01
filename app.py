...
if uploaded_file is not None:
    ...
    with st.status("🚀 구글 AI가 질환별 핵심 지표를 정밀 분석 중입니다...", expanded=True) as status:
        try:
            ...
            # [구조 전면 개편] 4대 만성질환 줄바꿈 강화 및 PART 5, PART 6 완벽 분리 지침
            prompt = """
            ...
            1. **가장 중요**: 각 PART가 시작되기 직전 줄에는 반드시 `---` 문법을 입력하여 시각적 구분 라인(구분선)을 그리세요.
            ...
            (※ 각 질환별 진단 사이에 빈 줄을 넣어 간격을 띄우고 본문 글을 상세히 풀어 쓰세요.)
